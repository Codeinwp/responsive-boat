<section class="about-us" id="aboutus">
    <div class="container">
        ...
        <div class="section-header">
            ...
            <?php
            $rb_aboutyou_title = get_theme_mod('rb_aboutyou_title',__('About you','responsive-boat'));
            ...
            $rb_aboutyou_subtitle = get_theme_mod('rb_aboutyou_subtitle',__('Use this section to showcase important details about you.','responsive-boat'));
            ...
            if( !empty($rb_aboutyou_subtitle) ):
                ...
                echo '<h6 class="white-text">';
                    ...
                    echo __($rb_aboutyou_subtitle,'responsive-boat');
        ...
        <div class="row">
            ...
            if( !empty($rb_aboutyou_text) ):
                ...
                echo __($rb_aboutyou_text,'responsive-boat');
