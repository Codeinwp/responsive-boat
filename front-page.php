				...
				<div class="row">
					...
					<?php
						...
						if(isset($emailSent) && $emailSent == true) :
							...
							echo '<div class="notification success"><p>'.__('Thanks, your email was sent successfully!','responsiveboat').'</p></div>';

						elseif(isset($_POST['submitted'])):

							echo '<div class="notification error"><p>'.__('Sorry, an error occured.','responsiveboat').'</p></div>';
